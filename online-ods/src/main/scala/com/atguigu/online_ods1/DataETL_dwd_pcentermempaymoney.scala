...
import com.atguigu.online_bean.{dwd_base_website, dwd_pcentermempaymoney}
import org.apache.spark.SparkConf
import org.apache.spark.rdd.RDD
import org.apache.spark.sql.SparkSession

object DataETL_dwd_pcentermempaymoney {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //读取hdfs数据源
    val source: RDD[String] = spark.sparkContext.textFile("/user/atguigu/ods/pcentermempaymoney.log")
